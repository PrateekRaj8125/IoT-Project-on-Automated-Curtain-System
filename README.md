...
## Code Implementation
Use the file available in Repository name [IoT Project](https://github.com/PrateekRaj8125/Arduino-Beginner-Project-Codes/tree/main/IoT_Project) for the code and implement them in the **Arduino IDE
**
